...
export class RegisterFormComponent {
  ...
  constructor(private authService: SocialAuthService, public __cartService: CartService, private renderer: Renderer2,
    ...
    this.registerForm = new FormGroup({
      ...
      "houseNumber": new FormControl({value: this.houseNo, disabled: this.disableHouseNo}, [Validators.required]),
      ...
      /* "passcode": new FormControl({value: this.postcode, disabled: true} )*/
    });
  }
